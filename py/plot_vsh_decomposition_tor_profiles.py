...
def plot_profiles():
    ...
    ax1.set_ylabel('field component', fontsize=10, color=INK_SECONDARY)
    ...
    ax2.set_xlabel(r'$\phi$ (rad)', fontsize=10, color=INK_SECONDARY)
    ax2.set_ylabel('field component', fontsize=10, color=INK_SECONDARY)
    ax2.set_title(r'$\phi$-dependence at $\theta=\pi/3$',
                  color=INK_PRIMARY, fontsize=11)
    ax2.legend(frameon=False, fontsize=8.5, labelcolor=INK_SECONDARY, ncol=2)
